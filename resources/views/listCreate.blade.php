...
<br><br><br><div class="container col-md-5 text-center modal-centered bg-white" style="box-shadow:0px 0px 8px rgba(0,0,0,0.1);border-radius:5px;">
	<br><h2 class="text-dark pull-left">Create New Task</h2><br><br>
	<form class="form" method="post" action="{{url('list')}}">
	@csrf
		<div class="form-group input-group">
			<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
			<input type="date" class="form-control" name="taskDate" id="tkDate">
		</div>
		<div class="form-group input-group">
			<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user-circle"></i></span></div>
			<input type="text" class="form-control" name="taskAuthor" id="tkAuthor" placeholder="Author name">
		</div>
		<div class="form-group input-group">
			<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-edit"></i></span></div>
			<input type="text" class="form-control" name="taskTitle" id="tkTitle" placeholder="Title name">
		</div>
		<div class="form-group input-group">
			<div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-edit"></i></span></div>
			<textarea type="text" class="form-control" name="taskDescription" id="tkDescription" placeholder="Describe task"></textarea>
		</div>
		<div class="form-group">
			<input type="submit" class="btn btn-success" value="Create" id="btnCreate">
		</div>
	</form><br>
</div>
@endsection
